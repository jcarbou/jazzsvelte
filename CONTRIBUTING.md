Contributing to JazzSvelte: Terms and Conditions
================================================

------------------------------------------------------------------------------

Do you want to contribute your work to JazzSvelte? Well, then first and most important: **THANK YOU!** 
...
**Important**: submitting any contributions to the JazzSvelte project implies your **full acceptance of these terms**,
including the *"JazzSvelte Individual Contributor License Agreement"* detailed at the end. 
...
How will your relation with the JazzSvelte project be?
-----------------------------------------------------
...
### General guidelines:
  ...
  - Prettier must pass without errors.
...
Note the following only applies to documentation/articles meant to be published at the JazzSvelte website.
  ...
  - Project members may edit and make small changes to your texts --of which you will be informed-- before 
    publishing them.
  - Format and visual styles must adhere to the JazzSvelte website standards, of which you will be informed
...
All JazzSvelte software is distributed under the **MIT** open source license, and your contributions
...
explained in this page, and that it both authorises your contribution to JazzSvelte and states that will 
never claim any kind of rights over it.



JazzSvelte Individual Contributor License Agreement
--------------------------------------------------

This contributor agreement ("Agreement") documents the rights granted by contributors to the JazzSvelte Project. 

This is a legally binding document, so please read it carefully before agreeing to it. The Agreement
may cover more than one software project managed by JazzSvelte.

### 1. Definitions

  * _"JazzSvelte"_ means the "JazzSvelte Project organization and members".
  * _"You"_ means the individual who submits a Contribution to JazzSvelte.
  * _"Contribution"_ means any work of authorship that is submitted by you to JazzSvelte in which you own
  ...
  * _"Material"_ means the work of authorship which is made available by JazzSvelte to third parties. When
    ...
    in the Material.
  * _"Submit"_ means any form of electronic, verbal, or written communication sent to JazzSvelte or its
    representatives, including but not limited to electronic mailing lists, source code control systems,
    and issue tracking systems that are managed by, or on behalf of, JazzSvelte for the purpose of discussing
  ...
  * _"Submission Date"_ means the date on which you submit a Contribution to JazzSvelte.
  * _"Effective Date"_ means the date you execute this agreement or the date You first submit a
    Contribution to JazzSvelte, whichever is earlier.
...
#### 2.1. Copyright License
    ...
    (b) To the maximum extent permitted by the relevant law, you grant to JazzSvelte a perpetual, worldwide,
...
own, control or have the right to grant, now or in the future, you grant to JazzSvelte a perpetual, worldwide,
...
As a condition on the grant of rights in Sections 2.1 and 2.2, JazzSvelte agrees to license the Contribution only
...
to assert such moral rights against JazzSvelte or its successors in interest, or any of our licensees, either 
direct or indirect.


#### 2.5 JazzSvelte Rights 

You acknowledge that JazzSvelte is not obligated to use your Contribution as part of the
Material and may decide to include any Contributions JazzSvelte considers appropriate.
...
FITNESS FOR A PARTICULAR PURPOSE AND NON-INFRINGEMENT ARE EXPRESSLY DISCLAIMED BY YOU TO JazzSvelte AND BY
JazzSvelte TO YOU. TO THE EXTENT THAT ANY SUCH WARRANTIES CANNOT BE DISCLAIMED, SUCH WARRANTY IS LIMITED IN 
...
TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT WILL YOU OR JazzSvelte BE LIABLE FOR ANY LOSS OF 
...
### 6. Miscellaneous
    ...
    6.2 This Agreement sets out the entire agreement between you and JazzSvelte for your Contributions to
        JazzSvelte and overrides all other agreements or understandings.
    6.3 If You or JazzSvelte assign the rights or obligations received through this Agreement to a third party, 
