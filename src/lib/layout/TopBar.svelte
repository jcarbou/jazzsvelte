<script lang="ts">
    ...
    import TopBarButton from '$lib/layout/TopBarButton.svelte'
    import TopBarLinkButton from '$lib/layout/TopBarLinkButton.svelte'
    import VersionDropdown from './VersionDropdown.svelte'
    import { JAZZ_SVELTE_CONTEXT } from '$lib/components/api/JazzSvelteContext'

    const { darkMode } = JAZZ_SVELTE_CONTEXT
