...
export interface ButtonPassThroughOptions {
     ...
     */
    root?: ButtonPassThroughType<HTMLAttributes<HTMLButtonElement>>
    /**
     * Uses to pass attributes to the loading icon's DOM element.
     */
    loadingIcon?: ButtonPassThroughType<SVGProps<SVGSVGElement> | HTMLAttributes<HTMLSpanElement | SVGSVGElement>>
    /**
     * Uses to pass attributes to the icon's DOM element.
     */
    icon?: ButtonPassThroughType<SVGProps<SVGSVGElement> | HTMLAttributes<HTMLSpanElement | SVGSVGElement>>
    /**
     * Uses to pass attributes to the label's DOM element.
     */
    label?: ButtonPassThroughType<HTMLAttributes<HTMLSpanElement>>
    /**
     * Uses to pass attributes to the badge's DOM element.
     */
    badge?: ButtonPassThroughType<HTMLAttributes<HTMLSpanElement>>
    /**
