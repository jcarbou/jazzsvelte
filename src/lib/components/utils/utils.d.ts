...
export declare class IconUtils {
    static getJSXIcon(icon: IconType<any>, iconProps: HTMLProps<HTMLElement>, options: any): any
}
...
export type IconOptions<ComponentProps, AdditionalProps> = AdditionalProps & {
     ...
     */
    iconProps: HTMLProps<any> | SVGProps<any>
    /**
...
export type IconType<ComponentProps, AdditionalProps = NonNullable<unknown>> = HTMLElement | ((options: IconOptions<ComponentProps, AdditionalProps>) => HTMLElement)

export type TemplateType<ComponentProps> = HTMLElement | ((props: ComponentProps) => HTMLElement)
