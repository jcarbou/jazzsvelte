...
import { removeAccents, resolveFieldData, equals } from '@jazzsvelte/object'
...
function toValues(
    ...
    | { noValues: true; filterValue: undefined; stringValue: undefined; filterAsDate: undefined }
    | { noValues: false; filterValue: string; stringValue: string; filterAsDate: DateLike } {
    ...
    return {
        noValues: false,
        filterValue: removeAccents(filter.toString()).toLocaleLowerCase(filterLocale),
        stringValue: removeAccents(value.toString()).toLocaleLowerCase(filterLocale),
