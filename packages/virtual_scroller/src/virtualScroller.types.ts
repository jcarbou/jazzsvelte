...
export type VirtualScrollerOptions = {
    index: number
    count: number
    first: boolean
    last: boolean
...
export interface BaseVirtualScrollerProps {
     ...
     * @default  null
     */
    numToleratedItems?: number | number[] | null
 ...
 * @group ptType
 */
export declare type VirtualScrollerPassThroughType<T> = PassThroughType<
...
export type InnerBothState = { rows: number; cols: number }
...
export interface VirtualScrollerState {
     ...
     */
    loaderArr: undefined[] | (undefined[] | undefined)[]
}
