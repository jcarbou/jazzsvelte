...
<Section title="Features" detail="PrimeReact is the most complete solution for your UI requirements.">
    <div class=" mt-7 px-3 lg:px-8">
        <div class="features-container">
            <div class="grid">
                <div class="col-12 md:col-6 xl:col-3 flex justify-content-center">
                    <div class="box p-4 w-full animation-duration-500">
                        <img src="/site/landing/features/icon-components.svg" alt="components icon" class="block mb-3" />
                        <div class="font-semibold mb-3 text-lg">80+ UI Components</div>
                        <p class="m-0 text-secondary font-medium">The ultimate set of UI Components to assist you with 80+ impressive React Components.</p>
                    </div>
                </div>
                <div class="col-12 md:col-6 xl:col-3 flex justify-content-center">
                    <div class="box p-4 w-full animation-duration-500">
                        <img src="/site/landing/features/icon-theme.svg" alt="components icon" class="block mb-3" />
                ...
                <div class="col-12 md:col-6 xl:col-3 flex justify-content-center">
                    <div class="box p-4 w-full animation-duration-500">
                        <img src="/site/landing/features/icon-community.svg" alt="components icon" class="block mb-3" />
                ...
                <div class="col-12 md:col-6 xl:col-3 flex justify-content-center">
                    <div class="box p-4 w-full animation-duration-500">
                        <img src="/site/landing/features/icon-accessibility.svg" alt="components icon" class="block mb-3" />
                ...
                <div class="col-12 md:col-6 xl:col-3 flex justify-content-center">
                    <div class="box p-4 w-full animation-duration-500">
                        <img src="/site/landing/features/icon-support.svg" alt="components icon" class="block mb-3" />
                ...
                <div class="col-12 md:col-6 xl:col-3 flex justify-content-center">
                    <div class="box p-4 w-full animation-duration-500">
                        <img src="/site/landing/features/icon-mobile.svg" alt="components icon" class="block mb-3" />
                ...
                <div class="col-12 md:col-6 xl:col-3 flex justify-content-center">
                    <div class="box p-4 w-full animation-duration-500">
                        <img src="/site/landing/features/icon-productivity.svg" alt="components icon" class="block mb-3" />
                ...
                <div class="col-12 md:col-6 xl:col-3 flex justify-content-center">
                    <div class="box p-4 w-full animation-duration-500">
                        <img src="/site/landing/features/icon-ts.svg" alt="components icon" class="block mb-3" />
