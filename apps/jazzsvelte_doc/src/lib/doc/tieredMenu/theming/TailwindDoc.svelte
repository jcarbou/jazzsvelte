...
const Tailwind = {
    tieredmenu: {
        root: {
            class: classs('py-1 bg-white border border-gray-300 rounded-lg w-[12.5rem]', 'dark:border-blue-900/40 dark:bg-gray-900')
        },
        menu: {
        ...
        action: ({ context }) => ({
            class: classs('py-3 px-5 select-none', 'flex items-center cursor-pointer no-underline relative overflow-hidden', {
        ...
        submenu: {
            class: classs('py-1 bg-white dark:bg-gray-900 border-0 shadow-md min-w-full', 'absolute z-10', 'left-full top-0')
        },
