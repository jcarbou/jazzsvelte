...
const Tailwind = {          
    ...
    progressspinner: {
        root: {
            class: classs('relative mx-auto w-28 h-28 inline-block', 'before:block before:pt-full')
        },
    ...
    const code2 = {
        javascript: `
${importJS('ProgressSpinner')}import { ProgressSpinner } from 'primereact/progressspinner';
