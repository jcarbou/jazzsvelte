...
const Tailwind = {
    panelmenu: {
        ...
        headeraction: {
            class: classs('flex items-center select-none cursor-pointer relative no-underline', 'text-gray-700 dark:text-white/80 p-5 font-bold')
        },
        submenuicon: 'mr-2',
        headericon: 'mr-2',
        ...
        action: {
            class: classs('text-gray-700 dark:text-white/80 py-3 px-5 select-none', 'flex items-center cursor-pointer no-underline relative overflow-hidden')
        },
        icon: 'mr-2',
