...
const Tailwind = {
     tabmenu: {
        ...
        menu: {
            class: classs('flex m-0 p-0 list-none flex-nowrap', 'bg-white border-solid border-gray-300 border-b-2', 'outline-none no-underline text-base list-none')
        },
        menuitem: 'mr-0',
    ...
    const code2 = {
        javascript: `
${importJS('TabMenu')}import { TabMenu } from 'primereact/tabmenu';
