<script lang="ts">
    ...
    import { tabMenuApiData } from '@jazzsvelte/tab_menu'
    ...
    import CommandDoc from './CommandDoc.svelte'
    import ControlledDoc from './ControlledDoc.svelte'
