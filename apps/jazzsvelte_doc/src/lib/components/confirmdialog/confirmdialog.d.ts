...
export declare type ConfirmDialogPassThroughTransitionType =
    | ReactCSSTransitionProps
    | ((options: ConfirmDialogPassThroughMethodOptions) => ReactCSSTransitionProps)
    | undefined
...
export interface ConfirmDialogPassThroughOptions {
     ...
     */
    headerIcons?: ConfirmDialogPassThroughType<
        React.SVGProps<SVGSVGElement> | React.HTMLAttributes<HTMLSpanElement | SVGSVGElement>
    >
    /**
     ...
     */
    closeButtonIcon?: ConfirmDialogPassThroughType<
        React.SVGProps<SVGSVGElement> | React.HTMLAttributes<HTMLSpanElement | SVGSVGElement>
    >
    /**
