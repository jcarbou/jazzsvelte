<script lang="ts">
    import AccessibilityDoc from '$lib/doc/badge/AccessibilityDoc.svelte'
    import BasicDoc from '$lib/doc/badge/BasicDoc.svelte'
...
<DocComponent
    ...
    componentDocs={docs}
    apiDocs={[apiDataToDocs(badgeApiData)]}
    {ptDocs}
    {themingDocs}
/>;
