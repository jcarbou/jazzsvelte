...
declare module '$env/static/private' {
	...
	export const npm_package_scripts_apidoc: string;
	export const npm_package_scripts_apiwebtypes: string;
	export const npm_package_scripts_build: string;
	export const npm_package_scripts_build_api: string;
	export const npm_package_scripts_build_check: string;
	export const npm_package_scripts_build_lib: string;
	export const npm_package_scripts_build_package: string;
	export const npm_package_scripts_build_package_dev: string;
	...
	export const npm_package_scripts_security_check: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_scripts_apidoc: string;
		npm_package_scripts_apiwebtypes: string;
		npm_package_scripts_build: string;
		npm_package_scripts_build_api: string;
		npm_package_scripts_build_check: string;
		npm_package_scripts_build_lib: string;
		npm_package_scripts_build_package: string;
		npm_package_scripts_build_package_dev: string;
		...
		npm_package_scripts_security_check: string;
